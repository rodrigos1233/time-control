  ...
  theme: {
    extend: {
      colors: {
        ...
        greenButtonBackgroundSecondary: 'var(--greenButtonBackgroundSecondary)',
        redButtonBackground: 'var(--redButtonBackground)',
        redButtonBackgroundSecondary: 'var(--redButtonBackgroundSecondary)',
