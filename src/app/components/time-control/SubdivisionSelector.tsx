...
export default function SubdivisionSelector({ selectedSubdivisionsOption, setSelectedSubdivisionsOption, selectedLengthOption }: SubdivisionSelectorProps) {
            ...
            label:
                <div className="flex flex-col items-center gap-1 justify-center">
                    <span className="flex gap-2">
                        <Image src={`/circle-${subdivision}.svg`} alt={`${subdivision} subdivisions`} width={22} height={22} />
                        {`${subdivision}`}
                    </span>
    ...
    return (
        <Selector options={options} selectedIndex={selectedSubdivisionsOption} setSelectedIndex={setSelectedSubdivisionsOption} />
    );
}