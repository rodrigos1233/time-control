        ...
        <div className="flex bg-black/[.05] rounded-xl p-1 relative">
            ...
            {options.map((option, index) => (
                <div
                    ...
                    className={`${selectedIndex === index ? "hover:bg-transparent cursor-default" : "hover:bg-amber-200 bg-transparent"} relative z-20 rounded-lg px-4 py-2 text-sm sm:text-base text-center flex-grow cursor-pointer`}
