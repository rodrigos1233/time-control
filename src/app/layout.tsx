...
export const metadata: Metadata = {
  ...
  description:
    'Web application allowing users to organise a duration into equal subdivisions, containing an analog and digital clocks to keep track of the passing time, with changing background colors as well as cricket and bell sounds.',
}
